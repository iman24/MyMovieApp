package com.imanancin.mymoviedb.data.source.remote.paging
...
import com.imanancin.mymoviedb.data.source.remote.response.ListMovieResponse
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, MovieResponse> {
        ...
        return try {
            ...
            val response: ListMovieResponse =  when(movieType) {
                ...
                MovieType.TRENDING -> apiService.getTrendingMovies(page = pageIndex)
